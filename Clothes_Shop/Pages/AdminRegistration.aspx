<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AdminRegistration.aspx.cs" Inherits="Pages_AdminRegistration" %>
...
<h1 class="pageLabelColor">
    ...
    <table align="center">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtConfirmPassword" runat="server" Width="212px"></asp:TextBox>
            </td>
            <td>
                <asp:RequiredFieldValidator ID="RequiredConfirmPassword" runat="server" ControlToValidate="txtPassword"
                    ErrorMessage="Must Confirm Password" Display="Dynamic" Font-Bold="True"
        ...
        <tr>
            ...
            <td>
                <asp:RequiredFieldValidator ID="RequiredMobile" runat="server" ControlToValidate="txtMobileNum"
                    ErrorMessage="Mobile is required " Display="Dynamic" Font-Bold="True" ForeColor="Red"></asp:RequiredFieldValidator>
