...
public partial class Pages_AdminAccount : System.Web.UI.Page
{
    ...
    private void GetAdminDetails()
    {
        ...
        {
            lblResult.Text = "Could not Retrieve Your Details!";
        }
    }
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            lblResult.Text = "Your Details Have Been Updated!";
        }
        catch (Exception)
        {
            lblResult.Text = "Could not Update Customer Details!";
        }
    }
}