...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <h1 style="color: #3366CC;">
        My Order</h1>
    <a href="Shopping_Cart.aspx" class="boldTextMedium">< Back to Cart</a>
    <h2 style="color: #3366CC;">
        Shipping Details</h2>
    <asp:Label ID="lblShippingAddress" runat="server" Text="Shipping Address:" CssClass="boldTextLarge"></asp:Label><br />
